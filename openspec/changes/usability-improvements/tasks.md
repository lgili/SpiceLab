...
- [ ] 1.1 Create `spicelab/templates/circuits.py` with common circuits
- [ ] 1.2 Add RC filter template with customizable fc
- [ ] 1.3 Add voltage divider template
...
- [ ] 2.1 Implement flexible unit parser: 1k, 1kohm, 1e3, 1000 all valid
- [ ] 2.2 Add "did you mean" suggestions for common typos (10u → 10µ)
- [ ] 2.3 Validate parameter ranges and warn on unusual values
- [ ] 2.4 Add unit system with automatic SI prefix handling
- [ ] 2.5 Support engineering notation: 1.5M, 22p, 470n
...
- [ ] 3.4 Warn on missing ground reference
- [ ] 3.5 Check for valid component connections (2-pin, 3-pin, etc.)

## 4. Workflow Shortcuts
- [ ] 4.1 Add `circuit.quick_ac(start=1, stop=1e9)` with smart defaults
- [ ] 4.2 Add `circuit.quick_tran(duration="1ms")` with auto-timestep
...
## 11. Testing
- [ ] 11.1 Test all templates produce valid circuits
- [ ] 11.2 Test error message clarity with user studies
- [ ] 11.3 Test shortcuts cover 80% of common workflows
