...
register_metadata_schema(
    MetadataSchema(
        ...
        fields=(
            ...
            FieldSchema("gbw", (str,), description="Gain bandwidth product"),
            FieldSchema("slew_rate", (str,), description="Slew rate"),
            FieldSchema("input_type", (str,), description="Input stage type (bipolar, jfet, fet)"),
            FieldSchema("supply", (str,), description="Supply type (single, dual) or range"),
            FieldSchema("noise", (str,), description="Input noise density"),
            FieldSchema("thd", (str,), description="Total harmonic distortion"),
            FieldSchema("voltage_gain", (str,), description="Voltage gain range"),
            FieldSchema("power_output", (str,), description="Power output"),
            FieldSchema("vos", (str,), description="Input offset voltage"),
            FieldSchema("drift", (str,), description="Offset voltage drift"),
            FieldSchema("quiescent", (str,), description="Quiescent current"),
            FieldSchema("rail_to_rail", (bool,), description="Rail-to-rail capability"),
            FieldSchema("cmrr", (str,), description="Common mode rejection ratio"),
            FieldSchema("gain_accuracy", (str,), description="Gain accuracy"),
            FieldSchema("type", (str,), description="Amplifier type"),
        ),
    ),
    overwrite=True,
)
